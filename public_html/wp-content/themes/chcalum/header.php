...
<link rel="profile" href="http://gmpg.org/xfn/11">
  ...
  <link href="<?php echo esc_url(''); ?>/wp-content/themes/chcalum/assets/css/style.css" type="text/css" rel="stylesheet" media="screen,projection"/>
...
<body <?php body_class(); ?>>
	  ...
	  <ul id="slide-out" class="side-nav fixed">
		  <div class="brand-logo">Quadrics</div>
		  <div class="profile">
	...
	<main><div class="secondary_nav  grey lighten-4">   <a href="#" data-activates="slide-out" class="button-collapse left hide-on-med-and-up black-text"><i class="material-icons">menu</i></a> <i class="material-icons">insert_chart</i>  <i class="material-icons">settings</i></div>
